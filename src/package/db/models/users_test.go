...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `Email`: `text`, `Name`: `text`, `Username`: `text`, `Phone`: `text`, `CreatedAt`: `timestamp without time zone`, `Location`: `text`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
