...
func testCategoryToManyIDCategoryPostCategories(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.IDCategoryPostCategories().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	for _, v := range check {
		if v.IDCategory == b.IDCategory {
			bFound = true
		}
		if v.IDCategory == c.IDCategory {
			cFound = true
		}
	}
	...
	if err = a.L.LoadIDCategoryPostCategories(ctx, tx, false, (*[]*Category)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.IDCategoryPostCategories); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.IDCategoryPostCategories = nil
	if err = a.L.LoadIDCategoryPostCategories(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.IDCategoryPostCategories); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testCategoryToManyIDCategoryProfileCategories(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, profileCategoryDBTypes, false, profileCategoryColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, profileCategoryDBTypes, false, profileCategoryColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.IDCategoryProfileCategories().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	bFound, cFound := false, false
	for _, v := range check {
		if v.IDCategories == b.IDCategories {
			bFound = true
		}
		if v.IDCategories == c.IDCategories {
			cFound = true
		}
	}
	...
	slice := CategorySlice{&a}
	if err = a.L.LoadIDCategoryProfileCategories(ctx, tx, false, (*[]*Category)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.IDCategoryProfileCategories); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.IDCategoryProfileCategories = nil
	if err = a.L.LoadIDCategoryProfileCategories(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.IDCategoryProfileCategories); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testCategoryToManyIDCategoryTattooCategories(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, tattooCategoryDBTypes, false, tattooCategoryColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, tattooCategoryDBTypes, false, tattooCategoryColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.IDCategoryTattooCategories().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := CategorySlice{&a}
	if err = a.L.LoadIDCategoryTattooCategories(ctx, tx, false, (*[]*Category)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.IDCategoryTattooCategories); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.IDCategoryTattooCategories = nil
	if err = a.L.LoadIDCategoryTattooCategories(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.IDCategoryTattooCategories); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testCategoryToManyAddOpIDCategoryPostCategories(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddIDCategoryPostCategories(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.ID != first.IDCategory {
			t.Error("foreign key was wrong value", a.ID, first.IDCategory)
		}
		if a.ID != second.IDCategory {
			t.Error("foreign key was wrong value", a.ID, second.IDCategory)
		}

		if first.R.IDCategoryCategory != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}
		if second.R.IDCategoryCategory != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}

		if a.R.IDCategoryPostCategories[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.IDCategoryPostCategories[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.IDCategoryPostCategories().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
...
func testCategoryToManyAddOpIDCategoryProfileCategories(t *testing.T) {
	var err error
	...
	var a Category
	var b, c, d, e ProfileCategory

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, categoryDBTypes, false, strmangle.SetComplement(categoryPrimaryKeyColumns, categoryColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*ProfileCategory{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, profileCategoryDBTypes, false, strmangle.SetComplement(profileCategoryPrimaryKeyColumns, profileCategoryColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*ProfileCategory{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddIDCategoryProfileCategories(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.ID != first.IDCategories {
			t.Error("foreign key was wrong value", a.ID, first.IDCategories)
		}
		if a.ID != second.IDCategories {
			t.Error("foreign key was wrong value", a.ID, second.IDCategories)
		}

		if first.R.IDCategory != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}
		if second.R.IDCategory != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}

		if a.R.IDCategoryProfileCategories[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.IDCategoryProfileCategories[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.IDCategoryProfileCategories().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testCategoryToManyAddOpIDCategoryTattooCategories(t *testing.T) {
	var err error
	...
	var a Category
	var b, c, d, e TattooCategory

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, categoryDBTypes, false, strmangle.SetComplement(categoryPrimaryKeyColumns, categoryColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*TattooCategory{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, tattooCategoryDBTypes, false, strmangle.SetComplement(tattooCategoryPrimaryKeyColumns, tattooCategoryColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*TattooCategory{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddIDCategoryTattooCategories(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.IDCategoryTattooCategories[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.IDCategoryTattooCategories[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.IDCategoryTattooCategories().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
var (
	categoryDBTypes = map[string]string{`ID`: `int8`, `Name`: `string`, `State`: `bool`, `Description`: `string`, `Slug`: `string`, `CreatedAt`: `timestamp`}
	_               = bytes.MinRead
)
