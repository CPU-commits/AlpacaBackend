...
var (
	tattooDBTypes = map[string]string{`ID`: `int8`, `IDProfile`: `int8`, `IDImage`: `int8`, `Likes`: `int4`, `Description`: `string`, `CreatedAt`: `timestamp`, `Popularity`: `int4`, `IDPost`: `int8`, `Views`: `int4`, `Coordinate`: `geometry`}
	_             = bytes.MinRead
)
