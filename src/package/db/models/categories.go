...
var CategoryWhere = struct {
	...
	State:       whereHelperbool{field: "\"categories\".\"state\""},
...
var CategoryRels = struct {
	IDCategoryPostCategories    string
	IDCategoryProfileCategories string
	IDCategoryTattooCategories  string
}{
	IDCategoryPostCategories:    "IDCategoryPostCategories",
	IDCategoryProfileCategories: "IDCategoryProfileCategories",
	IDCategoryTattooCategories:  "IDCategoryTattooCategories",
}

// categoryR is where relationships are stored.
type categoryR struct {
	IDCategoryPostCategories    PostCategorySlice    `boil:"IDCategoryPostCategories" json:"IDCategoryPostCategories" toml:"IDCategoryPostCategories" yaml:"IDCategoryPostCategories"`
	IDCategoryProfileCategories ProfileCategorySlice `boil:"IDCategoryProfileCategories" json:"IDCategoryProfileCategories" toml:"IDCategoryProfileCategories" yaml:"IDCategoryProfileCategories"`
	IDCategoryTattooCategories  TattooCategorySlice  `boil:"IDCategoryTattooCategories" json:"IDCategoryTattooCategories" toml:"IDCategoryTattooCategories" yaml:"IDCategoryTattooCategories"`
}
...
func (r *categoryR) GetIDCategoryPostCategories() PostCategorySlice {
	if r == nil {
		return nil
	}
	return r.IDCategoryPostCategories
}

func (r *categoryR) GetIDCategoryProfileCategories() ProfileCategorySlice {
	if r == nil {
		return nil
	}
	return r.IDCategoryProfileCategories
}

func (r *categoryR) GetIDCategoryTattooCategories() TattooCategorySlice {
	if r == nil {
		return nil
	}
	return r.IDCategoryTattooCategories
}
...
var (
	categoryAllColumns            = []string{"id", "name", "state", "description", "slug", "created_at"}
	categoryColumnsWithoutDefault = []string{"name", "description", "slug"}
	categoryColumnsWithDefault    = []string{"id", "state", "created_at"}
...
// IDCategoryPostCategories retrieves all the post_category's PostCategories with an executor via id_category column.
func (o *Category) IDCategoryPostCategories(mods ...qm.QueryMod) postCategoryQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"post_categories\".\"id_category\"=?", o.ID),
	)

	return PostCategories(queryMods...)
}

// IDCategoryProfileCategories retrieves all the profile_category's ProfileCategories with an executor via id_categories column.
func (o *Category) IDCategoryProfileCategories(mods ...qm.QueryMod) profileCategoryQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"profile_categories\".\"id_categories\"=?", o.ID),
	)

	return ProfileCategories(queryMods...)
}

// IDCategoryTattooCategories retrieves all the tattoo_category's TattooCategories with an executor via id_category column.
func (o *Category) IDCategoryTattooCategories(mods ...qm.QueryMod) tattooCategoryQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"tattoo_categories\".\"id_category\"=?", o.ID),
	)

	return TattooCategories(queryMods...)
}

// LoadIDCategoryPostCategories allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (categoryL) LoadIDCategoryPostCategories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		...
		qm.WhereIn(`post_categories.id_category in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.IDCategoryPostCategories = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &postCategoryR{}
			}
			foreign.R.IDCategoryCategory = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.IDCategory {
				local.R.IDCategoryPostCategories = append(local.R.IDCategoryPostCategories, foreign)
				if foreign.R == nil {
					foreign.R = &postCategoryR{}
				}
				foreign.R.IDCategoryCategory = local
				break
			}
		}
	}
...
// LoadIDCategoryProfileCategories allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (categoryL) LoadIDCategoryProfileCategories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		...
		qm.WhereIn(`profile_categories.id_categories in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.IDCategoryProfileCategories = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &profileCategoryR{}
			}
			foreign.R.IDCategory = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.IDCategories {
				local.R.IDCategoryProfileCategories = append(local.R.IDCategoryProfileCategories, foreign)
				if foreign.R == nil {
					foreign.R = &profileCategoryR{}
				}
				foreign.R.IDCategory = local
				break
			}
		}
	}
...
// LoadIDCategoryTattooCategories allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (categoryL) LoadIDCategoryTattooCategories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		...
		qm.WhereIn(`tattoo_categories.id_category in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.IDCategoryTattooCategories = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.IDCategory {
				local.R.IDCategoryTattooCategories = append(local.R.IDCategoryTattooCategories, foreign)
				if foreign.R == nil {
					foreign.R = &tattooCategoryR{}
				}
				foreign.R.IDCategoryCategory = local
...
// AddIDCategoryPostCategories adds the given related objects to the existing relationships
// of the category, optionally inserting them as new records.
// Appends related to o.R.IDCategoryPostCategories.
// Sets related.R.IDCategoryCategory appropriately.
func (o *Category) AddIDCategoryPostCategories(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostCategory) error {
	var err error
	...
	if o.R == nil {
		o.R = &categoryR{
			IDCategoryPostCategories: related,
		}
	} else {
		o.R.IDCategoryPostCategories = append(o.R.IDCategoryPostCategories, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &postCategoryR{
				IDCategoryCategory: o,
			}
		} else {
			rel.R.IDCategoryCategory = o
		}
	}
	return nil
}

// AddIDCategoryProfileCategories adds the given related objects to the existing relationships
// of the category, optionally inserting them as new records.
// Appends related to o.R.IDCategoryProfileCategories.
// Sets related.R.IDCategory appropriately.
func (o *Category) AddIDCategoryProfileCategories(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProfileCategory) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.IDCategories = o.ID
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
	...
	if o.R == nil {
		o.R = &categoryR{
			IDCategoryProfileCategories: related,
		}
	} else {
		o.R.IDCategoryProfileCategories = append(o.R.IDCategoryProfileCategories, related...)
	}
...
// AddIDCategoryTattooCategories adds the given related objects to the existing relationships
// of the category, optionally inserting them as new records.
// Appends related to o.R.IDCategoryTattooCategories.
// Sets related.R.IDCategoryCategory appropriately.
func (o *Category) AddIDCategoryTattooCategories(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TattooCategory) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.IDCategory = o.ID
	...
	if o.R == nil {
		o.R = &categoryR{
			IDCategoryTattooCategories: related,
		}
	} else {
		o.R.IDCategoryTattooCategories = append(o.R.IDCategoryTattooCategories, related...)
	}
...
func (o *Category) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert categories: %w", err)
	}
