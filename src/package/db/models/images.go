...
var ImageWhere = struct {
	...
	Key:       whereHelperstring{field: "\"images\".\"key\""},
	Name:      whereHelperstring{field: "\"images\".\"name\""},
	MimeType:  whereHelperstring{field: "\"images\".\"mimeType\""},
...
func (o *Image) GetIDImageAppointmentImage() *AppointmentImage {
	if o == nil {
		return nil
	}

	return o.R.GetIDImageAppointmentImage()
}
...
func (o *Image) GetIDImagePostImage() *PostImage {
	...
	return o.R.GetIDImagePostImage()
}
...
func (r *imageR) GetIDImagePostImage() *PostImage {
	...
	return r.IDImagePostImage
}

func (o *Image) GetIDAvatarProfile() *Profile {
	if o == nil {
		return nil
	}

	return o.R.GetIDAvatarProfile()
}

func (r *imageR) GetIDAvatarProfile() *Profile {
	if r == nil {
		return nil
	}
...
func (o *Image) GetIDAvatarStudio() *Studio {
	if o == nil {
		return nil
	}

	return o.R.GetIDAvatarStudio()
}
...
func (o *Image) GetIDBannerStudio() *Studio {
	if o == nil {
		return nil
	}

	return o.R.GetIDBannerStudio()
}
...
func (o *Image) GetIDImageTattoo() *Tattoo {
	if o == nil {
		return nil
	}

	return o.R.GetIDImageTattoo()
}
...
var (
	imageAllColumns            = []string{"id", "key", "name", "mimeType", "created_at"}
	imageColumnsWithoutDefault = []string{"key", "name", "mimeType"}
...
// IDAvatarProfile pointed to by the foreign key.
func (o *Image) IDAvatarProfile(mods ...qm.QueryMod) profileQuery {
	queryMods := []qm.QueryMod{
...
func (o *Image) IDImageTattoo(mods ...qm.QueryMod) tattooQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id_image\" = ?", o.ID),
	}
...
// loaded structs of the objects. This is for a 1-1 relationship.
func (imageL) LoadIDImagePostImage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage interface{}, mods queries.Applicator) error {
	var slice []*Image
	var object *Image
	...
	query := NewQuery(
		qm.From(`post_images`),
		qm.WhereIn(`post_images.id_image in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load PostImage")
	}

	var resultSlice []*PostImage
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice PostImage")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for post_images")
	}
	if err = results.Err(); err != nil {
	...
	if singular {
		foreign := resultSlice[0]
		object.R.IDImagePostImage = foreign
		if foreign.R == nil {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ID == foreign.IDImage {
				local.R.IDImagePostImage = foreign
				if foreign.R == nil {
					foreign.R = &postImageR{}
				}
				foreign.R.IDImageImage = local
...
// LoadIDAvatarProfile allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (imageL) LoadIDAvatarProfile(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage interface{}, mods queries.Applicator) error {
	var slice []*Image
	var object *Image
	...
	query := NewQuery(
		qm.From(`profiles`),
		qm.WhereIn(`profiles.id_avatar in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		foreign := resultSlice[0]
		object.R.IDAvatarProfile = foreign
		if foreign.R == nil {
			foreign.R = &profileR{}
		}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ID, foreign.IDAvatar) {
				local.R.IDAvatarProfile = foreign
				if foreign.R == nil {
					foreign.R = &profileR{}
				}
...
func (imageL) LoadIDImageTattoo(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`tattoos`),
		qm.WhereIn(`tattoos.id_image in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		foreign := resultSlice[0]
		object.R.IDImageTattoo = foreign
		if foreign.R == nil {
			foreign.R = &tattooR{}
		}
		foreign.R.IDImageImage = object
...
// SetIDImagePostImage of the image to the related item.
// Sets o.R.IDImagePostImage to related.
// Adds o to related.R.IDImageImage.
func (o *Image) SetIDImagePostImage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *PostImage) error {
	var err error
	...
	if o.R == nil {
		o.R = &imageR{
			IDImagePostImage: related,
		}
	} else {
		o.R.IDImagePostImage = related
	}

	if related.R == nil {
		related.R = &postImageR{
			IDImageImage: o,
		}
	} else {
		related.R.IDImageImage = o
...
// SetIDAvatarProfile of the image to the related item.
// Sets o.R.IDAvatarProfile to related.
// Adds o to related.R.IDAvatarImage.
func (o *Image) SetIDAvatarProfile(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Profile) error {
	var err error
	...
	if o.R == nil {
		o.R = &imageR{
			IDAvatarProfile: related,
		}
	} else {
		o.R.IDAvatarProfile = related
	}
...
// RemoveIDAvatarProfile relationship.
// Sets o.R.IDAvatarProfile to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Image) RemoveIDAvatarProfile(ctx context.Context, exec boil.ContextExecutor, related *Profile) error {
	var err error
...
// SetIDImageTattoo of the image to the related item.
// Sets o.R.IDImageTattoo to related.
// Adds o to related.R.IDImageImage.
func (o *Image) SetIDImageTattoo(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tattoo) error {
	var err error
	...
	if o.R == nil {
		o.R = &imageR{
			IDImageTattoo: related,
		}
	} else {
		o.R.IDImageTattoo = related
	}
