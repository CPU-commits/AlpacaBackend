...
var LikeTableColumns = struct {
	...
	ID:        "likes.id",
	IDUser:    "likes.id_user",
	IDProfile: "likes.id_profile",
	IDPost:    "likes.id_post",
...
var LikeWhere = struct {
	...
	IDUser:    whereHelperint64{field: "\"likes\".\"id_user\""},
	IDProfile: whereHelperint64{field: "\"likes\".\"id_profile\""},
	IDPost:    whereHelperint64{field: "\"likes\".\"id_post\""},
...
func (o *Like) GetIDUserUser() *User {
	if o == nil {
		return nil
	}
...
var (
	likeAllColumns            = []string{"id", "id_user", "id_profile", "id_post", "created_at"}
	likeColumnsWithoutDefault = []string{"id_user", "id_profile", "id_post"}
...
func (o *Like) IDProfileProfile(mods ...qm.QueryMod) profileQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (likeL) LoadIDProfileProfile(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLike interface{}, mods queries.Applicator) error {
	var slice []*Like
	var object *Like
	...
	if singular {
		...
		foreign.R.IDProfileLikes = append(foreign.R.IDProfileLikes, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.IDProfile == foreign.ID {
				...
				foreign.R.IDProfileLikes = append(foreign.R.IDProfileLikes, local)
				break
			}
		}
	}
...
// SetIDProfileProfile of the like to the related item.
// Sets o.R.IDProfileProfile to related.
// Adds o to related.R.IDProfileLikes.
func (o *Like) SetIDProfileProfile(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Profile) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &profileR{
			IDProfileLikes: LikeSlice{o},
		}
	} else {
		related.R.IDProfileLikes = append(related.R.IDProfileLikes, o)
	}
