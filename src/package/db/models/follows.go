...
func (o *Follow) GetIDStudioStudio() *Studio {
	if o == nil {
		return nil
	}
...
func (r *followR) GetIDStudioStudio() *Studio {
	if r == nil {
		return nil
	}
...
func (o *Follow) IDProfileProfile(mods ...qm.QueryMod) profileQuery {
...
func (o *Follow) IDStudioStudio(mods ...qm.QueryMod) studioQuery {
	queryMods := []qm.QueryMod{
...
func (o *Follow) IDUserUser(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
func (followL) LoadIDProfileProfile(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFollow interface{}, mods queries.Applicator) error {
	var slice []*Follow
	var object *Follow
	...
	if singular {
		...
		foreign.R.IDProfileFollows = append(foreign.R.IDProfileFollows, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.IDProfile, foreign.ID) {
				...
				foreign.R.IDProfileFollows = append(foreign.R.IDProfileFollows, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (followL) LoadIDStudioStudio(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFollow interface{}, mods queries.Applicator) error {
	var slice []*Follow
	var object *Follow
	...
	if singular {
		...
		foreign.R.IDStudioFollows = append(foreign.R.IDStudioFollows, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.IDStudio, foreign.ID) {
				...
				foreign.R.IDStudioFollows = append(foreign.R.IDStudioFollows, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (followL) LoadIDUserUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFollow interface{}, mods queries.Applicator) error {
	var slice []*Follow
	var object *Follow
	...
	if singular {
		...
		foreign.R.IDUserFollows = append(foreign.R.IDUserFollows, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.IDUser == foreign.ID {
				...
				foreign.R.IDUserFollows = append(foreign.R.IDUserFollows, local)
				break
			}
		}
	}
...
// SetIDProfileProfile of the follow to the related item.
// Sets o.R.IDProfileProfile to related.
// Adds o to related.R.IDProfileFollows.
func (o *Follow) SetIDProfileProfile(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Profile) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &profileR{
			IDProfileFollows: FollowSlice{o},
		}
	} else {
		related.R.IDProfileFollows = append(related.R.IDProfileFollows, o)
	}
...
func (o *Follow) RemoveIDProfileProfile(ctx context.Context, exec boil.ContextExecutor, related *Profile) error {
	var err error
	...
	for i, ri := range related.R.IDProfileFollows {
		if queries.Equal(o.IDProfile, ri.IDProfile) {
			continue
		}

		ln := len(related.R.IDProfileFollows)
		if ln > 1 && i < ln-1 {
			related.R.IDProfileFollows[i] = related.R.IDProfileFollows[ln-1]
		}
		related.R.IDProfileFollows = related.R.IDProfileFollows[:ln-1]
		break
	}
	return nil
}

// SetIDStudioStudio of the follow to the related item.
// Sets o.R.IDStudioStudio to related.
// Adds o to related.R.IDStudioFollows.
func (o *Follow) SetIDStudioStudio(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Studio) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &studioR{
			IDStudioFollows: FollowSlice{o},
		}
	} else {
		related.R.IDStudioFollows = append(related.R.IDStudioFollows, o)
	}
...
// Removes o from all passed in related items' relationships struct.
func (o *Follow) RemoveIDStudioStudio(ctx context.Context, exec boil.ContextExecutor, related *Studio) error {
	var err error
	...
	for i, ri := range related.R.IDStudioFollows {
		if queries.Equal(o.IDStudio, ri.IDStudio) {
			continue
		}

		ln := len(related.R.IDStudioFollows)
		if ln > 1 && i < ln-1 {
			related.R.IDStudioFollows[i] = related.R.IDStudioFollows[ln-1]
		}
		related.R.IDStudioFollows = related.R.IDStudioFollows[:ln-1]
		break
	}
	return nil
}

// SetIDUserUser of the follow to the related item.
// Sets o.R.IDUserUser to related.
// Adds o to related.R.IDUserFollows.
func (o *Follow) SetIDUserUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &userR{
			IDUserFollows: FollowSlice{o},
		}
	} else {
		related.R.IDUserFollows = append(related.R.IDUserFollows, o)
	}
...
func FindFollow(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Follow, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"follows\" where \"id\"=$1", sel,
	)
...
func (o *Follow) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(followPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert follows, could not build conflict column list")
			}

			conflict = make([]string, len(followPrimaryKeyColumns))
			copy(conflict, followPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"follows\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert follows")
	}
...
func (o *Follow) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"follows\" WHERE \"id\"=$1"
...
func FollowExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"follows\" where \"id\"=$1 limit 1)"
...
func (o *Follow) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return FollowExists(ctx, exec, o.ID)
}
