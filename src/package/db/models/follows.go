...
func (o *Follow) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryCockroachDB(dialect, "\"follows\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert follows: %w", err)
	}
