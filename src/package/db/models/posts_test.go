...
var (
	postDBTypes = map[string]string{`ID`: `bigint`, `IDProfile`: `bigint`, `IDStudio`: `bigint`, `IsStudioPost`: `boolean`, `Content`: `text`, `Likes`: `integer`, `Categories`: `ARRAY_text`, `Mentions`: `ARRAY_int4`, `Views`: `integer`, `Shares`: `integer`, `CreatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
